...
#### PC4 might be some kind of poverty indicator
...
These variables don't seem to make a clear story. Maybe something about birth rates and population growth? Or poverty?

```{r}

human_scaled_pca <- data.frame(pca_scaled$x)

#human_scaled_pca[order(human_scaled_pca$PC4)]
index <- order(human_scaled_pca$PC4)
human_scaled_pca[index]
