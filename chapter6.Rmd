...
### 1.1A Graphical displays, weight {.tabset .tabset-fade }
...
### 1.1B Graphical displays, weight gain {.tabset .tabset-fade }

The lines are difficult to compare because the groups' baselines are so different.
