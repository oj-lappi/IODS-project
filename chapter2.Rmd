...
Hmm, maybe the issue is the grading scale?

#### Let's grade on a curve!
...
```{r fig.align="center",  fig.width = 10, fig.cap = "2.1 Grading by standard deviation from median", fig.height= 10}
lrn2014 <- lrn2014 %>%
  mutate(quantile 
          = as.numeric(
              cut(lrn2014$points,
...
```{r fig.align="center",  fig.width = 10, fig.cap = "2.0 Regression diagnostics with gaussian standard deviation quantiles", fig.height= 10}
...
There is a lower resolution, so this way of doing things is much worse.

Ok, I don't think I have the statistics chops to go further from here.
