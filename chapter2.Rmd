...
I would interpret this to mean that, using the linear model, given `attitude`and `stra`, we estimate the expectation of the standard error of this prediction to be roughly 80% of what it would be when simply using the sample mean as a predictor.
